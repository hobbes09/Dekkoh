...
import com.dekkoh.activities.SplashActivity;
...
public class GooglePlusLoginController implements ConnectionCallbacks, OnConnectionFailedListener {
    ...
    public void onConnected(Bundle arg0) {
        ...
        if (Plus.PeopleApi.getCurrentPerson(mGoogleApiClient) != null) {
            ...
            // Toast.makeText(activity.getApplicationContext(), email+" "+personName,
    ...
    private class RetrieveTokenTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String token = null;
            try {
                token = GoogleAuthUtil.getToken(activity.getApplicationContext(), accountName,
                        scopes);
            } catch (IOException e) {
            ...
            try {
                DekkohUser dekkohUser = APIProcessor.loginUserWithGoogle(activity, userId, token,
                        email, null);
                if (dekkohUser != null) {
                    // Toast.makeText(activity.getApplicationContext(),
                    // dekkohUser.getInterestIds().toString(),Toast.LENGTH_LONG).show();
                    ...
                    // Toast.makeText(activity.getApplicationContext(),
                    // "Unable to Login ... Please Try Again.", Toast.LENGTH_LONG).show();
