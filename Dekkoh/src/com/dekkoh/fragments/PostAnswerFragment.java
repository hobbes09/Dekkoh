...
public class PostAnswerFragment extends BaseFragment implements OnClickListener {
    ...
    public PostAnswerFragment(Double latitude, Double longitude, boolean addressChanged,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        userNameAndLocationHolder = (RelativeLayout) root
                .findViewById(R.id.userNameAndLocationHolderPostAnswer);
        editAddress = (ImageView) root.findViewById(R.id.post_answer_fragment_userEditIcon);
        editTextForAddressHolder = (LinearLayout) root
                .findViewById(R.id.userLocationEditTextHolderPostQuestion);
        tickForAddressChanged = (ImageView) root
                .findViewById(R.id.continueAfterUserAddressChangePostAnswer);
        ...
        try {
            ...
            Toast.makeText(mContext, "Unable to get Location:" + e.toString(), Toast.LENGTH_LONG)
                    .show();
    ...
    private void customizeActionBar() {
        ...
        postAnswer = (ImageView) mCustomView
    ...
    public void gpsnMapUpdate() {
        try {
            if (addressChanged == false) {
                gpsTracker = new GPSTrackerService(activity,
                ...
                if (gpsTracker.canGetLocation() && locationManager
                    ...
                    if (addressList != null && addressList.size() > 0) {
                        ...
                        try {
                            ...
                            if (sb2.toString() != null && sb2.toString().compareTo("") != 0
                                ...
                                // Toast.makeText(mContext, sb2.toString(),
                                // Toast.LENGTH_LONG).show();
                            } else {

                                userLocation.setText(sb1.toString());
                                // Toast.makeText(mContext, sb1.toString(),
                                // Toast.LENGTH_LONG).show();
                            }
                        } catch (Exception e) {
                            Toast.makeText(mContext, "Unable to get Location:" + e.toString(),
                                    Toast.LENGTH_LONG).show();
                        }
                    }
                    ...
                    try {
                        ...
                        Toast.makeText(mContext, "Unable to load Map Location", Toast.LENGTH_SHORT)
                                .show();
                    }
        ...
        switch (v.getId()) {
            case R.id.postQuestion_postQuestionFragment_actionbar:
                ...
                if (userAnswerImage.isShown()) {
                    ...
                    userQuestionImageToPostToDekkohServer = googleMapFragmentHolder
                            .getDrawingCache();
                }
            ...
            case R.id.continueAfterUserAddressChangePostAnswer:
                if (editTextForUserAddress.getText().toString().replaceAll("\\s+", "")
                        .compareTo("") == 0) {
