...
public class PostQuestionFragment extends BaseFragment implements OnClickListener {
    ...
    public PostQuestionFragment(Double latitude, Double longitude, boolean addressChanged,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        userNameAndLocationHolder = (RelativeLayout) root
                .findViewById(R.id.userNameAndLocationHolderPostQuestion);
        ...
        try {
            ...
            locationManager = (LocationManager) activity
                    .getSystemService(getActivity().getApplicationContext().LOCATION_SERVICE); // 1*60*1000
                                                                                               // -
                                                                                               // 1min
