...
import com.dekkoh.custom.handler.FragmentTransitionManager;
...
public class QuestionFragment extends BaseFragment {
        ...
        root.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_UP) {
                    ...
                    SWIPE_ACTION = FragmentTransitionManager.detectSwipe(xDown,
                            xUp, yDown, yUp);
                    switch (SWIPE_ACTION) {
                        ...
                        case FragmentTransitionManager.SWIPE_RIGHT:
                            if (ApplicationState.getHomefeedQuestion_CurrentIndex() != 0) {
                                ...
                                nextQuestionFragment
                                        .setArguments(QuestionContentManager
                                                .getNextQuestionBundle(activity));
                                FragmentTransaction transactionPrevious = HomeFeedActivity.supportFragmentManager
                                        .beginTransaction();
                                transactionPrevious.setCustomAnimations(
                                        R.anim.slide_in_right,
                                        R.anim.slide_out_right);
                                transactionPrevious.replace(
                                        R.id.contentHomeActivity,
                                        nextQuestionFragment);
                        ...
                        case FragmentTransitionManager.SWIPE_LEFT:
                            ...
                            previousQuestionFragment
                                    .setArguments(QuestionContentManager
                                            .getPreviousQuestionBundle(activity));
                            FragmentTransaction transactionNext = HomeFeedActivity.supportFragmentManager
                                    .beginTransaction();
                            transactionNext.setCustomAnimations(
                                    R.anim.slide_in_left, R.anim.slide_out_left);
                            transactionNext.replace(R.id.contentHomeActivity,
                                    previousQuestionFragment);
                            transactionNext.commit();
                            break;
                        case FragmentTransitionManager.SWIPE_NULL:
                            Toast.makeText(getActivity(), "Swipe null Detected",
    ...
    private void initialize(View root) {
        ...
        profileImageFetcher.addImageCache(HomeFeedActivity.supportFragmentManager,
                cacheParams);
        questionImageFetcher = new RemoteImageFetcher(activity, 500);
        questionImageFetcher.setLoadingImage(R.drawable.loding_album);
        questionImageFetcher.addImageCache(HomeFeedActivity.supportFragmentManager,
                cacheParams);
    }
