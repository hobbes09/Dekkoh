...
public class QuestionFragment extends BaseFragment {
                    ...
                    switch (SWIPE_ACTION) {
                        ...
                        case FragmentTransitionManager.SWIPE_RIGHT:
                            if (ApplicationState.getHomefeedQuestion_CurrentIndex() != 0) {
                                ...
                                FragmentTransaction transactionPrevious = HomeScreen.supportFragmentManager
                                        .beginTransaction();
                        ...
                        case FragmentTransitionManager.SWIPE_LEFT:
                            ...
                            FragmentTransaction transactionNext = HomeScreen.supportFragmentManager
                                    .beginTransaction();
    ...
    private void initialize(View root) {
        ...
        profileImageFetcher.addImageCache(HomeScreen.supportFragmentManager,
                cacheParams);
        questionImageFetcher = new RemoteImageFetcher(activity, 500);
        questionImageFetcher.setLoadingImage(R.drawable.loding_album);
        questionImageFetcher.addImageCache(HomeScreen.supportFragmentManager,
                cacheParams);
    }
