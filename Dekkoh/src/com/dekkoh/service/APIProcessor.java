...
public class APIProcessor {
    ...
    /**
     * Method to Get all the answers or only the answers which matches some criteria
     * 
     * @param activity
     * @param offset
     * @param limit
    ...
    /**
     * Method to Get all the answers count or only the answers count which matches some criteria
     * 
     * @param activity
     * @param offset
     * @param limit
